...
from .compat import xrange, with_metaclass
...
from .command_map import CURSOR_UP, CURSOR_DOWN, CURSOR_PAGE_UP, CURSOR_PAGE_DOWN, CURSOR_MAX_LEFT, CURSOR_MAX_RIGHT
...
class ListBox(Widget, WidgetContainerMixin):
    ...
    def render(self, size, focus=False):
        ...
        if rows > maxrow:
            raise ListBoxError(
                "Listbox contents too long!  Probably urwid's fault (please report): %r" % ((top, middle, bottom),))
